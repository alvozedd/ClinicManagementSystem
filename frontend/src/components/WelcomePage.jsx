...
function WelcomePage() {
  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      console.log('Before saving - Current patients:', currentPatients);
      console.log('Before saving - Current appointments:', currentAppointments);
      console.log('New patient to be added:', newPatient);
      console.log('New appointment to be added:', newAppointment);

      // Save updated data to localStorage
      console.log('SAVING TO LOCALSTORAGE - Patients:', updatedPatients);
      console.log('SAVING TO LOCALSTORAGE - Appointments:', updatedAppointments);
      ...
      console.log('VERIFICATION - Patients after save:', verifyPatients);
      console.log('VERIFICATION - Appointments after save:', verifyAppointments);
      console.log('VERIFICATION - New patient in saved data:', verifyPatients.some(p => p.id === newPatient.id));
      console.log('VERIFICATION - New appointment in saved data:', verifyAppointments.some(a => a.id === newAppointment.id));
