  ...
  return (
    <div className="dashboard-container min-h-screen bg-gray-50">
      ...
      <div className="dashboard-layout flex">
        ...
        <aside className={`dashboard-sidebar ${isMobile ? (menuOpen ? 'block fixed inset-0 z-50 pt-16' : 'hidden') : 'block'} bg-white shadow-md w-64 min-h-screen`}>
          {isMobile && menuOpen && (
        ...
        <main className={`dashboard-main flex-1 p-4 ${isMobile ? 'pt-20' : ''}`}>
          <div className="content-container bg-white rounded-lg shadow-sm p-4 min-h-[calc(100vh-2rem)]">
            {children}
          </div>
        </main>
      </div>
