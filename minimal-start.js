// This file is used by Railway to start the application with minimal functionality
// to debug the path-to-regexp error
...
console.log('Starting the minimal server...');
require('./backend/minimal-server.js');
