...
const LoginScreen = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      const mockUsers = [
        { _id: '1', email: 'admin@urohealth.com', password: 'admin123', role: 'admin' },
        { _id: '2', email: 'doctor@urohealth.com', password: 'doctor123', role: 'doctor' },
        { _id: '3', email: 'secretary@urohealth.com', password: 'secretary123', role: 'secretary' },
      ];
            ...
            <div className="bg-red-50 border-l-2 border-red-400 p-2 mb-4">
              <div className="flex">
                <div className="flex-shrink-0">
                  <svg className="h-3 w-3 text-red-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="12" height="12">
          ...
          <form className="space-y-6" onSubmit={submitHandler}>
            ...
            <div>
              ...
              >
                {loading ? (
                  <>
                    <svg className="animate-spin -ml-1 mr-1 h-3 w-3 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width="12" height="12">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-1 gap-3">
              <div className="text-sm text-center text-gray-600">
                ...
                <p><strong>Admin:</strong> admin@urohealth.com / admin123</p>
                <p><strong>Doctor:</strong> doctor@urohealth.com / doctor123</p>
                <p><strong>Secretary:</strong> secretary@urohealth.com / secretary123</p>
              </div>
            </div>
          </div>
        </div>
