...
function AdminDashboard({ username }) {
  ...
  const [users, setUsers] = useState([
    { id: '1', username: 'admin', role: 'admin', email: 'admin@urohealth.com', lastLogin: '2023-06-15' },
    { id: '2', username: 'doctor', role: 'doctor', email: 'doctor@urohealth.com', lastLogin: '2023-06-20' },
    { id: '3', username: 'secretary', role: 'secretary', email: 'secretary@urohealth.com', lastLogin: '2023-06-18' },
    { id: '4', username: 'doctor2', role: 'doctor', email: 'doctor2@urohealth.com', lastLogin: '2023-06-10' },
    { id: '5', username: 'secretary2', role: 'secretary', email: 'secretary2@urohealth.com', lastLogin: '2023-06-12' },
  ]);
            ...
            <form onSubmit={handleUpdateUser} className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-gray-500">This will send a password reset email to the user</span>
                </div>
              </div>
